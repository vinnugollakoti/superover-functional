// here getting all the info from the html page
...
// audios for striking and game over
const strikeAudio = new Audio("http://bit.ly/so-ball-hit");
const gameOverAudio = new Audio("http://bit.ly/so-crowd-cheer");

// declaring all the vars as 0s
var team1Score = 0;
var team1Wickets = 0;
var team2Score = 0;
var team2Wickets = 0;
...
// possible outcomes when striking
...
// main fucntion when we click strike button
strikeButton.onclick = () => {
  ...
  // this is for pak score when trun is 2
  if (turn === 2) {
    team2BallsFaced++;
  ...
  //   calling the update function to update the scores of the team
  updateScore();
};
